...
structure = Structure.from_file(os.path.join(os.path.dirname(__file__)), 'tests/inputs/', 'POSCAR')
volume = Structure.volume

def test_volume_from_structure():
    assert volume == get_volume_from_structure(os.path.join(os.path.dirname(__file__)), 'tests/inputs/', 'POSCAR')
